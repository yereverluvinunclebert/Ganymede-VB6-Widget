   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":2D5F
            Left            =   1530
            List            =   "frmPrefs.frx":2D61
            Style           =   2  'Dropdown List
            TabIndex        =   56
   ...
   Begin VB.Frame fraConfig 
      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.ComboBox cmbScrollWheelDirection 
            Height          =   315
            ItemData        =   "frmPrefs.frx":4903
            Left            =   1995
            List            =   "frmPrefs.frx":4905
            Style           =   2  'Dropdown List
            TabIndex        =   90
...
'    gblPlhLocationPercPrefValue
    ...
    If gblPlStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "GanymedeMarbleWidget", """" & App.Path & "\" & "ganymede.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "GanymedeMarbleWidget", vbNullString)
    End If
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Ganymede-VB6-Widget", vbNullString, App.Path, 1)
    End If
End Sub
