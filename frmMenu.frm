...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Ganymede Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "Ganymede One-Page Help"
      End
...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Ganymede-VB6-Widget/raw/main/Setup.exe", vbNullString, App.Path, 1)
    End If
